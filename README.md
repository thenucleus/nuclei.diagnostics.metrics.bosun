...
The 'Nuclei.Diagnostics.Metrics.Bosun' assembly contains a set of classes and interfaces for metrics collection and forwarding to a [bosun](https://bosun.org/) instance.


# Installation instructions

All libraries are available on [NuGet.org](https://www.nuget.org/packages/Nuclei.Diagnostics.Metrics.Bosun/).
